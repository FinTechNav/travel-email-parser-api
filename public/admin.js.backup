...
function showModal(modalId) {
  ...
  // In your admin.js showModal function, add this case:
  if (modalId === 'createPromptModal') {
    setTimeout(() => {
...
function setupFormEventListeners() {
  ...
  // Create Prompt Form
  // In setupFormEventListeners() or setupPromptFormHandlers()
  ...
  if (createPromptForm) {
    createPromptForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        showAlert('danger', 'Failed to create prompt');
      }
    });
  }
    ...
    button.addEventListener('click', function (e) {
      ...
      switch (action) {
        ...
        case 'show-modal':
          ...
          if (targetModalId && typeof showModal === 'function') {
...
async function loadPrompts() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (typeof setupAdminActionListeners === 'function') {
